...
public class StringInitDemo {
    ...
    public static void main(String[] args) {
        ...
        // 1. Присвоение строкового литерала (неявно создается объект)
        String line1 = "This is String line";
        // 2. Создание объекта используя оператор new (используя один из существующих в классе конструкторов)
        String line2 = new String(); // создается пустая строка
        String line3 = new String("This is another String line");
        String line4 = new String(array); // создается строка из массива символов
...
//        String line8 = number; // ошибка компиляции, так нельзя
        ...
        // и менять приоритет можно расставляя скобки
